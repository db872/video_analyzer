...
Use the transcript as the global session context to infer the user journey and the key problem moments.
Return strict JSON.
...
Evidence should be short references to transcript observations.
